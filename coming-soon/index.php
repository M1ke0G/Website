...
<html>
	...
	<head>
		...
		<title>Lost Haven Roleplay - This page is coming soon.</title>
			...
			<div class="error-outer">
				<div class="error-middle">
					<div class="error-inner">
						<div class="error-text">COMING SOON</div>
						<div class="error-subtext">Follow us for updates <a href="https://twitter.com/losthavenrp" target="_blank">@losthavenrp</a></div>
					</div>
				</div>
			</div>
		</div>
